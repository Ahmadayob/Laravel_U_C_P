                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input id="title" value="{{ old('title')}}" type="text" name="title" autocomplete="given-name"
                                class="{{$errors->has('title') ? 'border-red-500' : 'outline-gray-300'}} block w-full rounded-md border-2 border-gray-300 bg-white px-3 py-2 text-base text-gray-900 placeholder:text-gray-400 focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600 sm:text-sm/6" />
                        </div>
                        @error('title')
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <input id="author" value="{{ old('author')}}" type="text" name="author" autocomplete="family-name"
                                class="{{$errors->has('author') ? 'border-red-500' : 'outline-gray-300'}} block w-full rounded-md border-2 border-gray-300 bg-white px-3 py-2 text-base text-gray-900 placeholder:text-gray-400 focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600 sm:text-sm/6" />
                        </div>
                        @error('author')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="body" name="body" rows="3"
                                class="{{$errors->has('body') ? 'border-red-500' : 'outline-gray-300'}} block w-full rounded-md border-2 border-gray-300 bg-white px-3 py-2 text-base text-gray-900 placeholder:text-gray-400 focus:border-indigo-600 focus:ring-2 focus:ring-indigo-600 sm:text-sm/6">{{ old('body') }}</textarea>
                        </div>
                        ...
                        <div class="flex gap-3">
                            <div class="flex h-6 shrink-0 items-center">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <svg class="absolute w-3.5 h-3.5 text-white pointer-events-none"
                                        style="left: 0.125rem; top: 0.125rem; display: none;" fill="none"
                            ...
                            <div class="text-sm/6">
                                ...
                                <p id="published-description" class="text-gray-500">Do you want to publish or saved as
                                    draft.</p>
                            </div>
                        </div>
                    </div>
